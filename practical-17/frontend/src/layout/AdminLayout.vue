<template>
  <div class="flex h-screen overflow-hidden bg-olive-50">
   <aside class="w-64 bg-olive-900 text-white flex flex-col h-screen">
      ...
      <nav class="flex-1 p-4 space-y-2">
        ...
        <router-link
          ...
          class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors"
          :class="$route.path === '/admin/subcategories' ? 'bg-olive-500' : 'hover:bg-olive-800'"
        >
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="p-4 border-t border-olive-800">
        <div class="flex items-center gap-3 mb-3">
          <div class="w-10 h-10 rounded-full bg-olive-500 flex items-center justify-center">
