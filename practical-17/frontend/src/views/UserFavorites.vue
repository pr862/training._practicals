<template>
  <div>
    <div class="mb-8">
      ...
      <p class="text-gray-600 mt-1">Products you've saved for later</p>
    </div>
    ...
    <div v-else-if="favoritesStore.favorites.length === 0" class="text-center py-20">
      ...
      <p class="mt-2 text-sm text-gray-500">Start browsing and add products to your favorites!</p>
      <router-link
        to="/"
        class="inline-block mt-4 px-6 py-3 bg-black text-white font-medium rounded-lg hover:bg-gray-900 transition-colors"
      >
        Browse Products
      </router-link>
    </div>
        ...
        >
          ...
          <div class="p-4">
            <h3 class="font-medium text-gray-900 mb-2 line-clamp-2">
              <router-link to="/" class="hover:text-gray-600">
                {{ product.name }}
              </router-link>
            </h3>
