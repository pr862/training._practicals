...
import { addGroupMembers, createGroupChat, deleteGroupChat, getOrCreateChat, leaveGroupChat, removeGroupMember } from "../../../packages/data/chat/service";
import { useAuth } from "../../app/context/Auth";
import { useChatDirectory } from "../../features/chat/useChatDirectory";
import { useCurrentUserProfile } from "./useCurrentUserProfile";
import { useUsersCollection } from "../../features/home/useUsersCollection";
...
export function useUsersDirectory() {
  ...
  const handleDeleteGroup = useCallback(async (nextChatId: string) => {
    if (!currentUser) return;
    await deleteGroupChat(nextChatId, currentUser.uid);
  }, [currentUser]);
